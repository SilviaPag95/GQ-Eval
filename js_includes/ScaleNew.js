...
jqueryWidget: {
    _init: function () {
        ...
        this.startColor = this.options.startColor ? parseColor(this.options.startColor) : parseColor("#22C1C3");
        this.endColor = this.options.endColor ? parseColor(this.options.endColor) : parseColor("#FDBB2D");
        ...
        if (this.options.scaleLabels) {
            ...
            this.$leftLabel.text("Definitely not ironic");
            this.$rightLabel.text("Definitely ironic");
        }
    ...
    setHandlePos: function () {
        ...
        if (this.options.scaleLabels) {
            this.$leftLabel.css('left', Math.floor(Math.round(barLeft - this.$leftLabel.width()/2)) + 'px');
            this.$leftLabel.css('top', (barTop + this.handleHeight) + 'px');
            this.$rightLabel.css('left', Math.round(barLeft + this.scaleWidth - this.$rightLabel.width()/2) + 'px');
